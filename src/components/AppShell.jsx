...
export function AppShell({ role, children, currentPath = window.location.pathname }) {
    ...
    return (<div className="min-h-screen flex bg-background">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-16 border-b border-border bg-card flex items-center justify-between px-4 sm:px-6 lg:px-8 gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3 relative shrink-0">
            ...
            {notifOpen && <NotifDropdown onClose={() => setNotifOpen(false)} notifications={notifications} loading={loading} />}
